...
public class Controller_Leaderboard implements Initializable {
    ...
    @FXML
    private TableView<Model_LeaderboardEntry> m_LeaderboardTable
            = new TableView<Model_LeaderboardEntry>();
    @FXML
    private TableColumn<Model_LeaderboardEntry,String> m_PlayerNameColumn
            = new TableColumn<>();
    @FXML
    private TableColumn<Model_LeaderboardEntry,Integer> m_ScoreColumn
            = new TableColumn<>();
     ...
     * @param location
     * @param resources
     * @Descripion initialize() will be activated as soon as Controller_leaderboard
